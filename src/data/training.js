                    ...
                    sections: [
                        {
                            ...
                            rows: [
                                ...
                                { itemEn: "Lo Mein", itemEs: "Lo Mein", v: { eggs: "●", shell: "●", wheat: "●", soy: "●", sesame: "●" }, vegan: "✓*", notesEn: "Wheat = egg noodles + soy sauce (NOT oyster sauce — ours is gluten-free). Sauce also has shellfish (oyster sauce) + 6 cups sesame oil. NOT gluten-free.", notesEs: "Trigo = fideos de huevo + salsa de soya (NO la salsa de ostión — la nuestra es sin gluten). La salsa también tiene mariscos (salsa de ostión) + 6 tazas de aceite de ajonjolí. NO sin gluten." },
