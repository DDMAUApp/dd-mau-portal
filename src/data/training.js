        ...
        lessons: [
            ...
            },
            {
                ...
                contentEn: [
                    ...
                    "Today we run two locations: Maryland Heights (MH) and Webster Groves (WG). You may be hired to work one or both. Either way, our standards are the same — the way we greet a guest, build a bowl, and close the kitchen should look identical at both stores.",
                ...
                contentEs: [
                    ...
                    "Hoy operamos dos ubicaciones: Maryland Heights (MH) y Webster Groves (WG). Es posible que te contraten para trabajar en una o ambas. De cualquier forma, nuestros estándares son iguales — la forma de saludar al cliente, armar un bowl y cerrar la cocina debe verse igual en ambas tiendas.",
            ...
            },
            {
                ...
                contentEn: [
                    "Three things make us different and they are non-negotiable.",
                    "1. Fresh meets fast. The pho broth simmered overnight. The vinaigrette was made this week. The egg rolls were rolled by hand in the back. We do not microwave anything we serve. Speed comes from prep, organization, and station discipline — not from cutting corners.",
                    "2. Vietnamese street food, elevated. Our menu is built on traditional Vietnamese flavors — fish sauce, lemongrass, fresh herbs, rice noodles, banh mi — but we plate them for a fast-casual setting. The flavors are real. The presentation is sharp. The price is fair.",
                    "3. Hospitality matters. We're a counter-service spot, but we are not a transaction machine. Eye contact. A smile. Greet the guest in 10 seconds. Read the room. The difference between a guest who comes back and one who doesn't is almost always how you made them feel — not the food.",
                ],
                contentEs: [
                    "Tres cosas nos hacen diferentes y no son negociables.",
                    "1. Fresco y rápido. El caldo de pho se cocinó toda la noche. La vinagreta se hizo esta semana. Los rollos primavera se enrollaron a mano. No microondamos nada de lo que servimos. La velocidad viene del prep, la organización y la disciplina de estación — no de tomar atajos.",
                    "2. Comida callejera vietnamita, elevada. Nuestro menú se construye sobre sabores vietnamitas tradicionales — salsa de pescado, hierba limón, hierbas frescas, fideos de arroz, banh mi — pero los presentamos para un ambiente casual rápido. Los sabores son reales. La presentación es nítida. El precio es justo.",
                    "3. La hospitalidad importa. Somos servicio de mostrador, pero no somos una máquina de transacciones. Contacto visual. Sonrisa. Saluda al cliente en 10 segundos. Lee la sala. La diferencia entre un cliente que regresa y uno que no, casi siempre es cómo lo hiciste sentir — no la comida.",
                ],
            },
            {
                id: "m1-l4",
                ...
                contentEn: [
                    ...
                    "✨ The Bright 4 — Eyes Up, Light Up, Speak Up, Show Up. Eyes Up means you're scanning for guests, not staring at the register. Light Up means you smile when they walk in. Speak Up means you greet them out loud. Show Up means you do the work — restock, run food, check the line — without being asked.",
                ...
                contentEs: [
                    ...
                    "✨ Los Bright 4 — Ojos Arriba, Cara Iluminada, Habla Alto, Aparece. Ojos Arriba significa que escaneas el local buscando clientes, no fijo en la caja. Cara Iluminada significa que sonríes cuando entran. Habla Alto significa que los saludas en voz alta. Aparece significa que haces el trabajo — reabastecer, llevar comida, revisar la línea — sin que te lo pidan.",
        ...
        lessons: [
            ...
            },
            {
                ...
                contentEn: [
                    ...
                    "Breaks. Shifts over 6 hours: one paid 30-minute meal break + one 10-minute rest break. Breaks are taken in the back, not on the floor. Phones can be used during your break only — never during your shift. Always check with the Shift Lead BEFORE you take your break — they need to make sure the floor stays covered.",
                ],
                contentEs: [
                    ...
                    "Descansos. Turnos de más de 6 horas: un descanso pagado de 30 minutos para comer + un descanso de 10 minutos. Los descansos se toman en la parte de atrás, no en el piso. Los teléfonos solo se usan en el descanso — nunca durante el turno. Siempre revisa con el líder ANTES de tomar tu descanso — necesita confirmar que el piso quede cubierto.",
                ],
            },
            {
                id: "m2-l3",
