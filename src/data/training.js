        ...
        lessons: [
            ...
            },
            {
                ...
                contentEn: [
                    ...
                    "BOBA MILK TEA DISCLOSURE — anytime a guest orders any boba milk tea, say this verbatim: \"Just so you know, our boba milk teas are non-dairy, but the creamer is made from a milk derivative — so if you have a milk allergy, please don't order one. Our fruit teas are completely safe — they never touch the creamer. Oat or soy milk teas also work.\" This is non-negotiable. The bag says 'Non-Dairy Creamer,' but the ingredients include sodium caseinate and lactose — both milk derivatives. A milk-allergic guest can have a serious reaction. We tell every guest, every time. If they say they're lactose-intolerant (digestion only, not an allergy), the creamer is usually fine for them. If they say allergy, redirect to a fruit tea (safest — separate build path) or oat/soy milk tea.",
                ...
                contentEs: [
                    ...
                    "AVISO DE BOBA MILK TEA — cada vez que un cliente pida cualquier boba milk tea, di esto al pie de la letra: \"Para que sepa, nuestros boba milk teas son non-dairy, pero la crema está hecha de un derivado lácteo — así que si tiene alergia a la leche, por favor no lo ordene. Nuestros fruit teas son completamente seguros — nunca tocan la crema. Milk teas con leche de avena o soya también funcionan.\" No es negociable. La bolsa dice 'Non-Dairy Creamer,' pero los ingredientes incluyen caseinato de sodio y lactosa — ambos derivados lácteos. Un cliente alérgico a la leche puede tener una reacción grave. Le decimos a cada cliente, cada vez. Si dice que es intolerante a la lactosa (solo digestión, no alergia), la crema usualmente está bien para él. Si dice alergia, redirígelo a un fruit tea (más seguro — proceso separado) o milk tea con leche de avena o soya.",
            ...
            questions: [
                ...
                },
                {
                    ...
                    options: [
                        ...
                        { id: "b", textEn: "Tell them our creamer contains a milk derivative (sodium caseinate + lactose) so they should NOT order it, and offer oat or soy milk tea instead", textEs: "Dile que nuestra crema contiene un derivado lácteo (caseinato de sodio + lactosa) y NO debe ordenarlo, y ofrécele milk tea con leche de avena o soya" },
                        { id: "c", textEn: "Make it with less creamer to be safe", textEs: "Hazlo con menos crema para estar seguro" },
                        { id: "d", textEn: "Get the manager and let them decide", textEs: "Llama al gerente y deja que decida" },
                    ],
                    correct: "b",
                },
            ],
        ...
        lessons: [
            ...
            },
            {
                ...
                contentEn: [
                    ...
                    "⚠ BOBA MILK TEA CREAMER — what's in the bag matters. Our 'non-dairy creamer' bag lists sodium caseinate, lactose, and milk flavor in the ingredients. Those ARE milk derivatives. If a guest tells the cashier they have a milk allergy and the cashier didn't catch it, we don't fix it at the boba station by making it 'extra non-dairy' — that's still milk. Stop the build, walk over to the cashier, and we sub oat or soy milk. If they're lactose-intolerant (digestion only, not allergy), our regular creamer is usually fine for them. Allergy = oat or soy. No exceptions.",
                ...
                contentEs: [
                    ...
                    "⚠ CREMA DE BOBA MILK TEA — lo que está en la bolsa importa. Nuestra bolsa de 'non-dairy creamer' lista caseinato de sodio, lactosa y sabor de leche en los ingredientes. Esos SÍ son derivados de leche. Si un cliente le dice al cajero que tiene alergia a la leche y el cajero no lo notó, NO lo arreglamos en la estación de boba haciéndolo 'extra non-dairy' — eso sigue siendo leche. Para el build, ve con el cajero, y sustituimos leche de avena o soya. Si es intolerante a la lactosa (solo digestión, no alergia), nuestra crema regular usualmente está bien. Alergia = avena o soya. Sin excepciones.",
                    ...
                    sections: [
                        ...
                        },
                        {
                            ...
                            rows: [
                                ...
                                { itemEn: "All Boba Milk Teas (9 flavors)", itemEs: "Todos los Boba Milk Teas (9 sabores)", v: { milk: "●", treenut: "◐", soy: "◐" }, vegan: "—", notesEn: "⚠ CRITICAL — creamer is labeled 'non-dairy' but ingredients include sodium caseinate + lactose + milk flavor. CONTAINS MILK ALLERGEN despite product name. A guest with a milk allergy WILL react. Oat or soy milk are the only milk-allergy-safe substitutes. Almond milk = tree nut allergen. Tapioca pearls themselves are typically allergen-free. Cashier MUST give the boba disclosure on every milk tea order.", notesEs: "⚠ CRÍTICO — la crema dice 'non-dairy' pero los ingredientes incluyen caseinato de sodio + lactosa + sabor de leche. CONTIENE ALÉRGENO DE LECHE a pesar del nombre. Un cliente alérgico SÍ reaccionará. Avena o soya son los únicos sustitutos seguros. Almendra = fruto seco. Las perlas de tapioca típicamente sin alérgenos. El cajero DEBE dar el aviso de boba en cada orden de milk tea." },
                                { itemEn: "Lychee Limeade, Boba Fruit Teas, Slushies, Hot Teas", itemEs: "Lychee Limeade, Boba Fruit Teas, Slushies, Tés Calientes", v: {}, vegan: "✓", notesEn: "Fruit & plain-tea drinks — no common allergens. SAFE for milk allergies: our fruit teas never touch the boba creamer (milk teas come pre-mixed with creamer; fruit-tea builds are a separate path). Recommend these as the milk-allergy-safe option alongside oat/soy milk teas.", notesEs: "Bebidas de fruta y té solo — sin alérgenos comunes. SEGURAS para alergia a leche: nuestros fruit teas nunca tocan la crema de boba (los milk teas vienen pre-mezclados con la crema; los fruit teas se arman por separado). Recomiéndalos como opción segura junto con milk teas de avena o soya." },
                            ],
                        },
                    ],
                },
