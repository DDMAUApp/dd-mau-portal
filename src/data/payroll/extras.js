...
export function validate(extra, masterByKey) {
    ...
    // 'xot_premium' is machine-generated by crossLocOt.js (arrives in final
    // shape, bypassing validate). It must never validate as a USER-entered
    // add — falling through here would return no amount_cents → NaN pay
    // (2026-08-26 adversarial review #6).
    if (t === 'xot_premium') return [null, `xot_premium is auto-generated — not user-enterable`];
    const key = extra.key || '';
